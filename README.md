...
- Horizontal picture mode (`orientation: horizontal` or `horizontal: true` with `show_images: true`) renders each tile as a full-width landscape image to fill available card width.
